...
function normalizeImageSource(value, fallback = "images/white_island.jpeg") {
        ...
        if (tripSnap.exists()) {
            ...
            document.getElementById("book-btn").addEventListener("click", async () => {
                ...
                document.querySelectorAll(".addon-checkbox:checked").forEach((checkbox) => {
                    ...
                    selectedAddons.push({ name: addonName, price, type, peopleCount: addonPeople, total: type === "per_person" ? price * addonPeople : price });
                });
